...
namespace HyparPickElement
{
    public class Function
    {
        ...
        private UrlModelStore<HyparPickElementInputs> store;

        public async Task<HyparPickElementOutputs> Handler(HyparPickElementInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<HyparPickElementInputs>();
            }
            

            var l = new InvocationWrapper<HyparPickElementInputs,HyparPickElementOutputs> (store, HyparPickElement.Execute);
