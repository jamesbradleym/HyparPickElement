...
{
	/// <summary>
	/// Override metadata for PossibleElementOverride
	/// </summary>
	public partial class PossibleElementOverride : IOverride
	{
        public static string Name = "Possible Element";
	...
	public static class PossibleElementOverrideExtensions
    {
		/// <summary>
        /// Apply Possible Element edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Possible Element Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<PossibleElementOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, PossibleElementIdentity, bool> identityMatch,
            Func<T, PossibleElementOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Possible Element Overrides to apply — typically `input.Overrides.PossibleElement`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<PossibleElementOverride> overrideData,
            Func<T, PossibleElementIdentity, bool> identityMatch,
            Func<T, PossibleElementOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.PossibleElement)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.PossibleElement)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.PossibleElement)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<PossibleElementOverride> edits,
            IList<PossibleElementOverrideAddition> additions,
            IList<PossibleElementOverrideRemoval> removals,            Func<PossibleElementOverrideAddition, T> createElement,
            Func<T, PossibleElementIdentity, bool> identityMatch,
            Func<T, PossibleElementOverride, T> modifyElement,
